...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            <label for="is_vendedor" class="label-cb">{{ __('Seleccione su rol') }}</label>
            <select class="form-control" id="is_vendedor" name="is_vendedor" required>
                <option value="cliente">{{ __('Cliente') }}</option>
                <option value="vendedor">{{ __('Vendedor') }}</option>
            </select>
        </div>
